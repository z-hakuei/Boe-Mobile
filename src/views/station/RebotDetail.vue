<template>
    <div id="robotdetail">
            ...
            <ul>
                <li>
                    <div style='position:relative;width:100px;margin:0 auto;'>
                        ...
                        <div class='two'></div>
                        <div class='three'></div>
                        <div class='four'><i class="iconfont icon-qingsao"></i>
                            <div class="wenzi">清扫次数:{{Count}}次</div>
                        </div>
                    </div>
                </li>
                <li>
                    <div style='position:relative;width:100px;margin:0 auto;'>
                        ...
                        <div class='two'></div>
                        <div class='three'></div>
                        <div class='four'><i class="iconfont icon-chixushichang"></i>
                            <div class="wenzi">清扫时长:{{Hours}}h</div>
                        </div>
                    </div>
                </li>
                <li>
                    <div style='position:relative;width:100px;margin:0 auto;'>
                        ...
                        <div class='two'></div>
                        <div class='three'></div>
                        <div class='four'><i class="iconfont icon-chongdian"></i>
                            <div class="wenzi">充放电次数:{{Charge}}次</div>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div style='position:relative;width:100px;margin:0 auto;'>
                        ...
                        <div class='two'></div>
                        <div class='three'></div>
                        <div class='four'><i class="iconfont icon-dianliang"></i>
                            <div class="wenzi">剩余电量:{{Quantity}}%</div>
                        </div>
                    </div>
                </li>
                <li>
                ...
                <li>
                    <div style='position:relative;width:100px;margin:0 auto;'>
                        ...
                        <div class='two'></div>
                        <div class='three'></div>
                        <div class='four'><i class="iconfont icon-shebei"></i>
                            <div class="wenzi">设备状态:{{Status}}</div>
                        </div>
                    </div>
                </li>
            </ul>
        ...
        <div id="content2" class="box">
            <div class="square" @click="RebotManage(0)">
                <div class="boderX"><i class="iconfont icon-zanting"></i>
                    <div class="sss">暂停</div>
                </div>
            </div>
            <div class="square" @click="RebotManage(1)">
                <div class="boderX"><i class="iconfont icon-qidong"></i>
                    <div class="sss">启动</div>
                </div>
            </div>
            <div class="square" @click="RebotManage(2)">
                <div class="boderX"><i class="iconfont icon-fanhui"></i>
                    <div class="sss">返转</div>
                </div>
            </div>
        </div>
...
<style scoped>
    ...
    .square {
        background: linear-gradient(#34E4FC, #34E4FC) left top,
